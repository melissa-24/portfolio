  ...
  return (
    <div className="profile-wrapper">
      ...
      <div className="section-header" id="current">
        <h2>Current Projects<a href="#top"><img src="https://images.craftsnherbs.com/top.jpg" /></a></h2>
      </div>
      <div className="profile-text">
        ...
        <div className="project-card">
          ...
          <a href="https://water-my-plants-ui.netlify.app/" target="_blank"><img src="https://images.craftsnherbs.com/portfolio/watermyplants.jpg" /></a>
        </div>
        <div className="project-card">
          <h4>2nd Collaberation Build - My job was UI</h4>
          <a href="https://re-mix.netlify.app/" target="_blank"><img src="https://images.craftsnherbs.com/portfolio/remix.jpg" /></a>
        </div>
        <div className="project-card">
          <h4>1st Professional Build - Updated Bi-Weekly</h4>
          <a href="https://lah-photpgraphy.com" target="_blank"><img src="https://images.craftsnherbs.com/portfolio/lah.jpg" /></a>
        </div>
        <div className="project-card">
          <h4>Personal Crocheting Website</h4>
          <a href="https://honeybeescrochet.com" target="_blank"><img src="https://images.craftsnherbs.com/portfolio/crochet01.jpg" /></a>
        </div>
        <div className="project-card">
      ...
      <div className="profile-text">
        ...
        <div className="project-card">
          ...
          <img src="https://images.craftsnherbs.com/portfolio/irishgardens01.png" />
        </div>
        <div className="project-card">
          <h4>Same site a few years later</h4>
          <img src="https://images.craftsnherbs.com/portfolio/irishgardens02.png" />
        </div>
        <div className="project-card">
          <h4>5 years later same site</h4>
          <img src="https://images.craftsnherbs.com/portfolio/irishgardens03.png" />
        </div>
      </div>
    </div>
  );
